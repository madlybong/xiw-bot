...
<template>
    <v-container>
        ...
        <v-card border>
            <v-data-table :headers="headers" :items="contacts" :search="search" :loading="loading">
                <template v-slot:top>
        ...
        <v-dialog v-model="importDialog" max-width="400px">
            <v-card>
                ...
                <v-card-text>
                    <v-file-input v-model="importFile" label="Select .csv file" accept=".csv" show-size></v-file-input>
